...
const CACHE_VERSION = "citronex-jobs-v50-application-reference-2026-07-25";
const CORE_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./data/content.js?v=50",
  "./data/locales/ru.js?v=50",
  "./data/locales/en.js?v=50",
  "./assets/styles.css?v=50",
  "./assets/i18n.js",
  "./assets/application-form.js?v=50",
  "./assets/app.js?v=50",
  "./assets/icons.svg",
...
const OPTIONAL_LOCALES = [
  "./data/locales/uk.js?v=50",
  "./data/locales/pl.js?v=50",
  "./data/locales/az.js?v=50",
  "./data/locales/ka.js?v=50",
  "./data/locales/id.js?v=50",
  "./data/locales/es.js?v=50",
  "./data/locales/fil.js?v=50",
  "./data/locales/ne.js?v=50",
  "./data/locales/hy.js?v=50"
];
