...
const CACHE_VERSION = "citronex-jobs-v64-experience-coach-2026-07-25";
const CORE_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./data/content.js?v=64",
  "./data/locales/ru.js?v=64",
  "./data/locales/en.js?v=64",
  "./assets/styles.css?v=64",
  "./assets/i18n.js",
  "./assets/application-form.js?v=64",
  "./assets/app.js?v=64",
  "./assets/icons.svg",
...
const OPTIONAL_LOCALES = [
  "./data/locales/uk.js?v=64",
  "./data/locales/pl.js?v=64",
  "./data/locales/az.js?v=64",
  "./data/locales/ka.js?v=64",
  "./data/locales/id.js?v=64",
  "./data/locales/es.js?v=64",
  "./data/locales/fil.js?v=64",
  "./data/locales/ne.js?v=64",
  "./data/locales/hy.js?v=64"
];
