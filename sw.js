...
const CACHE_VERSION = "citronex-jobs-v71-trust-style-2026-07-25";
const CORE_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./data/content.js?v=71",
  "./data/locales/ru.js?v=71",
  "./data/locales/en.js?v=71",
  "./assets/styles.css?v=71",
  "./assets/i18n.js",
  "./assets/application-form.js?v=71",
  "./assets/app.js?v=71",
  "./assets/icons.svg",
...
const OPTIONAL_LOCALES = [
  "./data/locales/uk.js?v=71",
  "./data/locales/pl.js?v=71",
  "./data/locales/az.js?v=71",
  "./data/locales/ka.js?v=71",
  "./data/locales/id.js?v=71",
  "./data/locales/es.js?v=71",
  "./data/locales/fil.js?v=71",
  "./data/locales/ne.js?v=71",
  "./data/locales/hy.js?v=71"
];
