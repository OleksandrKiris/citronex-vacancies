...
const CACHE_VERSION = "citronex-jobs-v66-send-checklist-2026-07-25";
const CORE_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./data/content.js?v=66",
  "./data/locales/ru.js?v=66",
  "./data/locales/en.js?v=66",
  "./assets/styles.css?v=66",
  "./assets/i18n.js",
  "./assets/application-form.js?v=66",
  "./assets/app.js?v=66",
  "./assets/icons.svg",
...
const OPTIONAL_LOCALES = [
  "./data/locales/uk.js?v=66",
  "./data/locales/pl.js?v=66",
  "./data/locales/az.js?v=66",
  "./data/locales/ka.js?v=66",
  "./data/locales/id.js?v=66",
  "./data/locales/es.js?v=66",
  "./data/locales/fil.js?v=66",
  "./data/locales/ne.js?v=66",
  "./data/locales/hy.js?v=66"
];
