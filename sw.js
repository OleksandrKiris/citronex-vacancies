...
const CACHE_VERSION = "citronex-jobs-v120-resource-progress-2026-07-25";
const CORE_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./data/content.js?v=120",
  "./data/locales/ru.js?v=120",
  "./data/locales/en.js?v=120",
  "./assets/styles.css?v=120",
  "./assets/i18n.js?v=120",
  "./assets/application-form.js?v=120",
  "./assets/app.js?v=120",
  "./assets/icons.svg",
  ...
  "./assets/share-card-v11.png?v=120"
];
const OPTIONAL_LOCALES = [
  "./data/locales/uk.js?v=120",
  "./data/locales/pl.js?v=120",
  "./data/locales/az.js?v=120",
  "./data/locales/ka.js?v=120",
  "./data/locales/id.js?v=120",
  "./data/locales/es.js?v=120",
  "./data/locales/fil.js?v=120",
  "./data/locales/ne.js?v=120",
  "./data/locales/hy.js?v=120"
];
