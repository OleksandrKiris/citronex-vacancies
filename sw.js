...
const CACHE_VERSION = "citronex-jobs-v60-language-chips-2026-07-25";
const CORE_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./data/content.js?v=60",
  "./data/locales/ru.js?v=60",
  "./data/locales/en.js?v=60",
  "./assets/styles.css?v=60",
  "./assets/i18n.js",
  "./assets/application-form.js?v=60",
  "./assets/app.js?v=60",
  "./assets/icons.svg",
...
const OPTIONAL_LOCALES = [
  "./data/locales/uk.js?v=60",
  "./data/locales/pl.js?v=60",
  "./data/locales/az.js?v=60",
  "./data/locales/ka.js?v=60",
  "./data/locales/id.js?v=60",
  "./data/locales/es.js?v=60",
  "./data/locales/fil.js?v=60",
  "./data/locales/ne.js?v=60",
  "./data/locales/hy.js?v=60"
];
