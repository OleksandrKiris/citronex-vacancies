(function () {
  ...
  window.PORTAL_TRANSLATIONS.en = {
    ...
    ui: {
      ...
      trustIntro: "No registration. I receive your details only after you send the message.",
      ...
      jobsIntro: "Check the conditions, pay and accommodation photos. If the job suits you, complete the questionnaire and send it to me on WhatsApp.",
