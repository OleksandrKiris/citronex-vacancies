(function () {
  ...
  window.PORTAL_TRANSLATIONS.en = {
    ...
    ui: {
      ...
      antiFraudWarning: "Do not send money, bank details or document photos. If anyone asks, stop and contact the recruiter using the WhatsApp number shown on this website.",
      recruiterEyebrow: "I reply personally",
      ...
      trustIntro: "The questionnaire runs in your browser. I receive your information only after you press “Send” in WhatsApp.",
      ...
      finalText: "Answer a few short questions — we will show suitable jobs and prepare a WhatsApp message.",
      startSurvey: "Find a match in 2–3 minutes",
      jobsKicker: "Job catalogue",
      jobsTitle: "All current vacancies",
      jobsIntro: "Choose a job first. Conditions and the questionnaire open inside each vacancy.",
    ...
    form: {
      ...
      stepReview: "Review",
      sectionTravel: "Accommodation and travel",
      ...
      employerTransport: "Do you need transport from the employer?",
      independentArrival: "Can you travel to the workplace independently?",
